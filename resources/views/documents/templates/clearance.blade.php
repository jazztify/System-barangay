...
<body>
    ...
    <div class="content">
        ...
        {{ $municipality }}, {{ $province }}, is known to be of GOOD MORAL CHARACTER
        and has NO DEROGATORY RECORD filed in this barangay.</p>
