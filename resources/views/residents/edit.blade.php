...
@section('header_title', 'Edit Resident Record')
...
<div class="card">
    <div class="card-header border-0 bg-transparent">
        <div class="d-flex align-items-center">
            ...
            <h5 class="mb-0">Edit: {{ $resident->full_name }}</h5>
        </div>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{ route('residents.update', $resident->resident_id) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="date_of_birth" class="form-control" value="{{ old('date_of_birth', $resident->date_of_birth) }}" required>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="contact_no" class="form-control" value="{{ old('contact_no', $resident->contact_no) }}">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="household_id" class="form-select">
                        ...
                        @foreach($households as $h)
                            <option value="{{ $h->household_id }}" {{ old('household_id', $resident->household_id)==$h->household_id?'selected':'' }}>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="resident_since" class="form-control" value="{{ old('resident_since', $resident->resident_since) }}">
                </div>
                    ...
                    <div class="d-flex flex-wrap gap-4">
                        @foreach([
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="{{ $field }}" value="1" id="{{ $field }}" {{ old($field, $resident->$field) ? 'checked' : '' }}>
            ...
            <div class="mt-4 pt-3 border-top d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-1"></i> Update Resident
                </button>
            </div>
        </form>
    </div>
